...
Pet.create!(user: danwoo, name: 'Kara', post_type: 'Foster', animal: 'Dog', breed: 'Black Lab', age: 13, description: 'Lover of food, tennis balls, and tummy rubs, Kara is a patient and gentle doggo who is great with kids.', foster_length: '1 year')
